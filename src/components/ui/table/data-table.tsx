		...
		<div className="space-y-4">
			...
			<div className="flex flex-col items-center justify-end gap-2 space-x-2 py-4 sm:flex-row">
				<div className="flex w-full items-center justify-between">
					...
					<div className="flex flex-col items-center gap-4 sm:flex-row sm:gap-6 lg:gap-8 text-muted-foreground">
				...
				<div className="flex w-full items-center justify-between gap-2 sm:justify-end text-muted-foreground">
