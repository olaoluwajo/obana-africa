    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 transition-all duration-200">
      <div className="relative bg-slate-50 p-6 rounded shadow-md md:w-[45%] w-[80%] max-h-[90%] overflow-auto">
        ...
        <div>
          ...
          <p className="mb-4">
            Welcome to <b>Obana Africa!</b> To ensure a smooth onboarding
            experience, please follow the steps outlined below. Once registered
            and approved, you’ll be able to list your products on our platform.
          </p>
          ...
          <ul className="list-disc list-inside mb-4">
            <li>
              Complete the vendor registration form with accurate details.
            </li>
            <li>
              After submission, our team will review your application and notify
              you of approval status within 5 business days.
            </li>
          </ul>
          <h2 className="text-xl font-bold mb-2">
            Step 2: Product Upload Process
          </h2>
          <ul className="list-disc list-inside mb-4 space-y-2">
            <li>
              <b> Download the Product Sample Sheet: </b>
              Once approved, download the product sample sheet provided on your
              vendor dashboard.
            </li>
        ...
        <button
          onClick={onClose}
          className="mt-4 bg-[#43828d] hover:bg-[#539dab]  text-white py-2 px-4 rounded w-full "
        >
          Continue
        </button>
      </div>
